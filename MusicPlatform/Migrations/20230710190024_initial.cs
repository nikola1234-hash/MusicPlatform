        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Listeners = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Plays = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FanBases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FanBases_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FanBases_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FanBases_ArtistId",
                table: "FanBases",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_FanBases_UserId",
                table: "FanBases",
                column: "UserId");
